...
copy-fig-for-paper:
	cp ProcessedResultImages/l2strideSmallLarge/FCTcomparison.pdf  ProcessedResultImages/LargeStrideFCTcomparison.pdf
	cp ProcessedResultImages/l2strideSmallLarge/DataLosscomparison.pdf  ProcessedResultImages/LargeStrideDataLosscomparison.pdf
	cp ProcessedResultImages/l2strideSmallLarge/RetransmissionComparison.pdf  ProcessedResultImages/LargeStrideRetransmissionComparison.pdf

	cp ProcessedResultImages/l2strideSmallLarge-strideCount-4/FCTcomparison.pdf  ProcessedResultImages/SmallStrideFCTcomparison.pdf
	cp ProcessedResultImages/l2strideSmallLarge-strideCount-4/DataLosscomparison.pdf  ProcessedResultImages/SmallStrideDataLosscomparison.pdf
	cp ProcessedResultImages/l2strideSmallLarge-strideCount-4/RetransmissionComparison.pdf  ProcessedResultImages/SmallStrideRetransmissionComparison.pdf

	cp ProcessedResultImages/l2multihighContention/FCTcomparison.pdf  ProcessedResultImages/MultiHighContentionFCTcomparison.pdf
	cp ProcessedResultImages/l2multihighContention/DataLosscomparison.pdf  ProcessedResultImages/MultiHighContentionDataLosscomparison.pdf
	cp ProcessedResultImages/l2multihighContention/RetransmissionComparison.pdf  ProcessedResultImages/MultiHighContentionRetransmissionComparison.pdf

	cp ProcessedResultImages/l2highContention/FCTcomparison.pdf  ProcessedResultImages/IncastFCTcomparison.pdf
	cp ProcessedResultImages/l2highContention/DataLosscomparison.pdf  ProcessedResultImages/IncastDataLosscomparison.pdf
	cp ProcessedResultImages/l2highContention/RetransmissionComparison.pdf  ProcessedResultImages/IncastRetransmissionComparison.pdf
