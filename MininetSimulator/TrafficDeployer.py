    ...
    try:
        for l in lines:
            ...
            if(host == myhostName):
                ...
                logger.info("Total tokens in line is "+str(len(tokens)))
        ...
        logger.info("Oserror ocurred in "+myhostName+" for executing Client command "+command+" oserror is "+str(oe))
    except Exception as e:
        logger.info("Exception ocurred in "+myhostName+" for executing Client command "+command+" exception is "+str(e))
