...
class ControlPacket:
    ...
    def __init__(self, packet):
        ...
        # self.path_delay_event_data= int.from_bytes(packet.metadata[13].value, byteorder='big', signed=True)
        # self.dest_IPv6_address= ipaddress.IPv6Address( packet.metadata[14].value ) # eed to convert this to ipv6 address
        # self.path_delay_event_port=int.from_bytes(packet.metadata[15].value, byteorder='big', signed=True)
        pass
