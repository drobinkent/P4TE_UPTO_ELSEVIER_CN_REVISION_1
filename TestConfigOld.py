...
class IPerfDeplymentPair:
    def __init__(self,src, dest, srcPort, destPort,srcHostName, destHostName, testCaseName, startTime,flowSizeinPackets, trafficClassTag):
        '''
        ...
        self.trafficClassTag = trafficClassTag
        access_rights = 0o777
        try:
