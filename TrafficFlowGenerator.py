...
if __name__ == "__main__":
    ...
    testEvaluator.generateTestCommandsAsJsonFile( testCaseNAme= "WebSearchWorkLoad_load_factor_0.2",loadFactor=0.05,testDuration=150,maxPortcountInSwitch=ConfigConst.MAX_PORT_COUNT)
...
#                                         serverPortStart=confConst.IPERF3_SERVER_PORT_START, testStartDelay=10)
#     testEvaluator.setupTestCaseFolder()
#     testEvaluator.generateTestCommands( testCaseNAme= "WebSearchWorkLoad_load_factor_0.4",loadFactor=0.4,testDuration=150,maxPortcountInSwitch=ConfigConst.MAX_PORT_COUNT)
#
#     #--------------------
#     testEvaluator = TestCommandDeployer(topologyConfigFilePath = confConst.TOPOLOGY_CONFIG_FILE,resultFolder = "FlowInfos" , clientPortStart=confConst.IPERF3_CLIENT_PORT_START,
#                                         serverPortStart=confConst.IPERF3_SERVER_PORT_START, testStartDelay=10)
#     testEvaluator.setupTestCaseFolder()
#     testEvaluator.generateTestCommands( testCaseNAme= "WebSearchWorkLoad_load_factor_0.5",loadFactor=0.5,testDuration=150,maxPortcountInSwitch=ConfigConst.MAX_PORT_COUNT)
#
#     #--------------------
#     testEvaluator = TestCommandDeployer(topologyConfigFilePath = confConst.TOPOLOGY_CONFIG_FILE,resultFolder = "FlowInfos" , clientPortStart=confConst.IPERF3_CLIENT_PORT_START,
#                                         serverPortStart=confConst.IPERF3_SERVER_PORT_START, testStartDelay=10)
#     testEvaluator.setupTestCaseFolder()
#     testEvaluator.generateTestCommands( testCaseNAme= "WebSearchWorkLoad_load_factor_0.7",loadFactor=0.7,testDuration=150,maxPortcountInSwitch=ConfigConst.MAX_PORT_COUNT)
#
#     #--------------------
#     testEvaluator = TestCommandDeployer(topologyConfigFilePath = confConst.TOPOLOGY_CONFIG_FILE,resultFolder = "FlowInfos" , clientPortStart=confConst.IPERF3_CLIENT_PORT_START,
#                                         serverPortStart=confConst.IPERF3_SERVER_PORT_START, testStartDelay=10)
#     testEvaluator.setupTestCaseFolder()
#     testEvaluator.generateTestCommands( testCaseNAme= "WebSearchWorkLoad_load_factor_0.8",loadFactor=0.8,testDuration=200,maxPortcountInSwitch=ConfigConst.MAX_PORT_COUNT)
